...
public class ProfileAdapter extends BaseAdapter {
    ...
    public ProfileAdapter(Activity activity, List<HomeListModel> listItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.row_item_profile, null);


        final HomeListModel listModel = listItems.get(position);
        TextView title = (TextView) convertView.findViewById(R.id.text_name_profile);
