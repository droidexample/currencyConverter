...
public class MyRequestListAdapter extends BaseAdapter {
    ...
    public MyRequestListAdapter(Activity activity, List<HomeListModel> listItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.my_request_list_item, null);


        final HomeListModel listModel = listItems.get(position);
        TextView title = (TextView) convertView.findViewById(R.id.tv_usd);
