 ...
 */
public class MyRequestsActiveList {
    ...
    public static void setAllReqestActive(Vector<MyReqestActiveMoel> allEventinfo) {
        MyRequestsActiveList.allReqestActiveList = allEventinfo;
    }
    ...
    public static void setReqestActiveinfo(MyReqestActiveMoel _alldonorList) {
        MyRequestsActiveList.allReqestActiveList.addElement(_alldonorList);
    }
    public static void removeAllReqestActiveList() {
        MyRequestsActiveList.allReqestActiveList.removeAllElements();
    }
}
