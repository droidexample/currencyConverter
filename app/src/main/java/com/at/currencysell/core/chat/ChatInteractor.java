package com.at.currencysell.core.chat;

import android.content.Context;
import android.util.Log;

import com.at.currencysell.fcm.FcmNotificationBuilder;
import com.at.currencysell.model.Chat;
import com.at.currencysell.utils.Constants;
import com.at.currencysell.utils.SharedPrefUtil;
...
public class ChatInteractor implements ChatContract.Interactor {
    ...
    public void getMessageFromFirebaseUser(String senderUid, String receiverUid) {
        ...
        databaseReference.child(Constants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(room_type_1)) {
                    Log.w(TAG, "getMessageFromFirebaseUser: " + room_type_1 + " exists");
                    ...
                    Log.w(TAG, "getMessageFromFirebaseUser: " + room_type_2 + " exists");
                    FirebaseDatabase.getInstance()
                            .getReference()
                            .child(Constants.ARG_CHAT_ROOMS)
