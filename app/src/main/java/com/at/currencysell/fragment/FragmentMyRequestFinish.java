...
import com.at.currencysell.holder.MyRequestsFinishList;
...
public class FragmentMyRequestFinish extends Fragment {
    ...
    public void doWebRequestForRequestFinish() {

        MyRequestsFinishList.removeAllReqestActiveList();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseUrl.HttpUrl + "my-request-success", new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (success==1) {
                        ...
                        for (int i = 0; i < JsonMain.length(); i++) {
                            ...
                            MyRequestsFinishList.setReqestActiveinfo(model);

                        }

                        adapter = new MyRequestsAdapter(mContext, MyRequestsFinishList.getAllReqestActive());
