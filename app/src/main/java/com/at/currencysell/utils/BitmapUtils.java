...
public class BitmapUtils {
	...
	public static Vector<Bitmap> getBitmapFromAsset(Context con, String path) throws IOException
    {
      ...
      for(String s:files)
      {
    	  try
    	  {
    	  temp.addElement(BitmapFactory.decodeStream(am.open(path+"/"+s)));
    	  }catch(Exception e)
    	  {
	...
	public static Bitmap getResizedBitmapByDeviceWidth(Bitmap src, int deviceWidth)
	{
	...
	public static Bitmap getResizedBitmapUsingMatrix(final Bitmap BitmapOrg, int x, int y,
													 final boolean flag) {
